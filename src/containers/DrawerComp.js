...
class DrawerComp extends Component {
    ...
    render() {
        console.log(" state fo drawer comp",this.state)
          return (
            <DrawerLayoutAndroid  onLayout={this.detectOrientation} style={{backgroundColor:"#fed987d6",flex:1}} 
             ...
             isPortrait = {this.state.isPortrait} closeDrawer={this.closeDrawer} 
                ...
                <ImageBackground  style={{width: undefined,flex:this.state.isPortrait ? 0.13:0.23,flexDirection: 'row',
                 backgroundColor:"#ec5343", justifyContent:"center" }}  source={require('../public/small-icons.png')}> 
                   ...
                   <Text style={styles.title}>Palm Predict</Text>
                   </TouchableOpacity>
                   {/* <Text style={styles.title}>Crack React JS</Text> */}
                    {this.props.showDetailScreenStatus ? 
                   <TouchableOpacity  style={styles.appButton} onPress={()=>{this.shareContent()}}>
                   ...
                   <TouchableOpacity  style={styles.appButton} onPress={()=>{ 
                       this.setState({showTutorialScreen : true}) }}>
                        <Image style={styles.appImage}  source={require('../public/about_us.png')} />
                    </TouchableOpacity> }
                </ImageBackground>
                ...
                {/* <AdMobBanner style={styles.admob} adSize="smartBanner" adUnitID="ca-app-pub-3940256099942544/6300978111"/> */}
                   ...
                   {/* ToastAndroid.show('Please choose any one of the action to proceed!', ToastAndroid.SHORT); */}
                        ...
                        {!this.state.updateData ? 
                            ...
                            <Text style={{color:"#26365a",fontFamily:"quicksand_bold"}}>Few data changes available...</Text>
                            <Text style={styles.updateInfo}>
                                This is not an app update. We will update predictions only.</Text>
                            <Text>{'\n'}</Text>
                            ...
                            <TouchableOpacity style={styles.updatePopButton} onPress={this.remindMe}>
                                <Text style={styles.ignoreText}>Remind Me Later</Text>
                            </TouchableOpacity>
                        ...
                        <View style={styles.modalContentWrapper}>
                            ...
                            <ActivityIndicator size={50} color="#ec5343" />
                         </View> 
                        }
                        </View>
                   </Modal>
